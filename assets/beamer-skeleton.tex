...
% Theme: Metropolis (matze/mtheme, ~7k stars on GitHub) — minimal,
% back-row-readable, and shipped with every full TeX Live / MiKTeX
% as "beamertheme-metropolis", so there is nothing to install manually.
% Metropolis is (c) Matthias Vogelgesang, LPPL — if you redistribute
% modified decks under its name, see the theme's own license notes.
%
...
% ---------- Latin fonts ----------
% Times for body text keeps numbers looking professional. Do NOT load
...
% \hl      highlight the one number that matters, in the theme accent
